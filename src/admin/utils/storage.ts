...
const SCHOOL_DATA_VERSION = 'mothibisi-v2';
...
const defaultContact: ContactInfo = {
  address: 'Thaba-Chicha A/A, P.O. Box 1809, Matatiele, 4730 (Eastern Cape)',
...
const defaultAbout: AboutInfo = {
  historyParagraphs: [
    'Mothibisi Senior Secondary School is a public school proudly serving learners at Thaba-Chicha A/A, Matatiele, in the Alfred Nzo West District of the Eastern Cape.',
    'Located within the Alfred Nzo West Education District under CMC Matatiele, Mothibisi SSS is committed to academic excellence, disciplined learning, and community values. Our motto — "We Strive to Excel" — reflects the spirit of every learner who walks through our doors.',
  ...
  principalMessage: [
    'Welcome to Mothibisi Senior Secondary School. We believe every learner carries within them the capacity for greatness. Our role is to unlock it — through discipline, love, and unwavering belief in their potential.',
    'We value respect, responsibility, and pride in our school community. Hard work pays, and at Mothibisi SSS, we are committed to proving that amidst every difficulty, we rise.',
  ],
};
