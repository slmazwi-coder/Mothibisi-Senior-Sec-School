  ...
  return (
    <footer className="pt-12 pb-8 w-full" style={{ background: '#FFFFFF', borderTop: '4px solid #800020' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm italic mt-0.5" style={{ color: 'rgba(128,0,32,0.65)' }}>
                  "We Strive to Excel"
                </p>
              </div>
            </div>
          ...
          <div>
            <h4 className="text-sm font-bold mb-4 pb-2 uppercase tracking-wide"
              style={{ color: '#800020', borderBottom: '1px solid rgba(128,0,32,0.25)' }}>
              Contact Us
            </h4>
            <ul className="space-y-3 text-sm" style={{ color: 'rgba(128,0,32,0.8)' }}>
              <li className="flex items-start gap-2">
                <MapPin className="shrink-0 mt-0.5" size={16} />
                <span>Thaba-Chicha A/A, Mt Fletcher, Eastern Cape</span>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: 'rgba(128,0,32,0.8)' }}>
        ...
        <div className="pt-6 text-center text-xs" style={{ borderTop: '1px solid rgba(128,0,32,0.15)', color: 'rgba(128,0,32,0.5)' }}>
          <p>© {new Date().getFullYear()} Mothibisi Senior Secondary School. All Rights Reserved.</p>
          <Link to="/admin/login" className="text-xs mt-2 inline-block transition-colors hover:opacity-80"
            style={{ color: 'rgba(128,0,32,0.3)' }}>
            Staff Portal
          </Link>
        </div>
      </div>
