...
// the Mothibisi defaults in storage.ts take effect immediately.
const DATA_VERSION = 'mothibisi-v2';
if (localStorage.getItem('data_version') !== DATA_VERSION) {
  Object.keys(localStorage)
    .filter(k => k.startsWith('admin_') || k.startsWith('mh_') || k.startsWith('mothibisi_'))
